...
vim.api.nvim_set_keymap('n', '<leader>gg', ":botright vsplit | vertical resize 100 | term<cr>gemini<cr>", { noremap = true })
...
vim.api.nvim_set_keymap('n', '<leader>ms', '<cmd>Markview splitToggle<cr>', { noremap = true})
